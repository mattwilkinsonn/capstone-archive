...
func (c *authClient) Logout(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*LogoutReply, error) {
	out := new(LogoutReply)
...
func (UnimplementedAuthServer) Logout(context.Context, *empty.Empty) (*LogoutReply, error) {
